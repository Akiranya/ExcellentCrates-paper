...
public class CrateUser extends AbstractUser<ExcellentCrates> {
    ...
    public @NotNull Map<String, Long> getCrateCooldowns() {
    ...
    public @NotNull Map<String, Integer> getOpeningsAmountMap() {
    ...
    public @NotNull Map<String, Integer> getKeysMap() {
        return this.keys;
    }

    public @NotNull Map<String, Integer> getKeysOnHold() {
    ...
    public @NotNull Map<String, Map<String, UserRewardData>> getRewardWinLimits() {
        return rewardWinLimits;
    }

    public @Nullable UserRewardData getRewardWinLimit(@NotNull CrateReward reward) {
        return this.getRewardWinLimit(reward.getCrate().getId(), reward.getId());
    }

    public @Nullable UserRewardData getRewardWinLimit(@NotNull String crateId, @NotNull String rewardId) {
        return this.getRewardWinLimits()
            .getOrDefault(crateId.toLowerCase(), Collections.emptyMap())
    ...
    public void setRewardWinLimit(@NotNull String crateId, @NotNull String rewardId, @NotNull UserRewardData rewardLimit) {
        this.getRewardWinLimits()
            .computeIfAbsent(crateId.toLowerCase(), k -> new HashMap<>())
    ...
    public void removeRewardWinLimit(@NotNull String crateId, @NotNull String rewardId) {
        this.getRewardWinLimits()
            .getOrDefault(crateId.toLowerCase(), new HashMap<>())
