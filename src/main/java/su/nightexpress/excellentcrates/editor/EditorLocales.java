...
public class EditorLocales extends su.nexmedia.engine.api.editor.EditorLocales {
    ...
    public static final EditorLocale CRATE_OBJECT = builder(PREFIX + "CRATE_OBJECT")
        .name(Placeholders.CRATE_NAME + " <gray>(ID: <white>" + Placeholders.CRATE_ID + "</white>)")
        .actionsHeader()
    ...
    public static final EditorLocale REWARD_OBJECT = builder(PREFIX + "REWARD_OBJECT")
        .name(Placeholders.REWARD_NAME + " <gray>(ID: <white>" + Placeholders.REWARD_ID + "</white>)")
        .text("Chance: <white>" + Placeholders.REWARD_CHANCE + "%")
        .text("Rarity: <white>" + Placeholders.REWARD_RARITY_NAME).breakLine()
